...
\]
The ratio bound (3.2) and (6.1) make $u_T$ bounded.  Its weak limit is
$Q\Om_g$ by the same weak-graph argument.  Boundedness of $e^{-tH/2}$ and weak
lower semicontinuity of the norm prove (6.5).
...
\Because The two sets of unit localization squares are separated by a horizontal
strip of width at least $t-2$.  Apply CE2 with $d\geq t-2$ and use
$e^{-m_1(t-2)}=e^{2m_1}e^{-m_1t}$.
