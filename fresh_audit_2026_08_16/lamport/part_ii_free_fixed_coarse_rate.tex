...
\]
For \(r=0\), $P_0=1$ and $|\ell|\le\pi$; the claimed bound follows from
$C_D\ge(1+\pi)^{2+\eta}$, which holds for
$C_D=48\pi^4e^{1/6}$.  Finally, take \(r\to\infty\) in (2.12) and use (1.2) to obtain the
