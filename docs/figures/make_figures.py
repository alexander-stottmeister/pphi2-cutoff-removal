...
def main():
    ...
    # resolved before the module body runs, so there is no loading state to race, no
    # fetch to fail, and the figures work from a file:// checkout as well as from Pages.
