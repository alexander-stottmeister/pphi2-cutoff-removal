...
% Self-contained preamble.  This document previously loaded audit_2026/auditstyle.sty,
% which is not on the TeX search path when pdflatex is run in this directory, so the
% build stopped before producing any output.  Everything it used from that file --
% the package set, the page style and the resultbox environment -- is reproduced here.
...
\newenvironment{resultbox}{\begin{center}\begin{minipage}{0.94\textwidth}\hrule\vspace{6pt}}{\vspace{6pt}\hrule\end{minipage}\end{center}}
