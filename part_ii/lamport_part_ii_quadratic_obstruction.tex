...
\end{align}
The first term tends to $\cos(s\theta_0)$.  The second tends to zero by the same
four-residue calculation as (3.3)--(3.4), now with the Riemann integrand
$\eta(x)\eta(x-\eps_Ns)$, which converges uniformly to $\eta(x)^2$.
